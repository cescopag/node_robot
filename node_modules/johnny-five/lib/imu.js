  ...
  SHT31D: {
    ...
    initialize: {
      value: function(board, opts) {
        ...
        // write(data, 0, 2) - write(buffer, offset, size)
        io.i2cWrite(address, 2, this.REGISTER.SETUP);
  ...
  BMP180: {
    initialize: {
      value: function(opts) {
        ...
        state.altimeter = new Altimeter(
          Object.assign({
            controller: opts.controller || "BMP180",
            freq: opts.freq,
            board: this.board,
          }, opts)
        );
  ...
  BMP280: {
    initialize: {
      value: function(opts) {
        ...
        state.altimeter = new Altimeter(
          Object.assign({
            controller: opts.controller || "BMP280",
            freq: opts.freq,
            board: this.board,
          }, opts)
        );
  ...
  BME280: {
    initialize: {
      value: function(opts) {
        ...
        state.altimeter = new Altimeter(
          Object.assign({
            controller: opts.controller || "BME280",
            freq: opts.freq,
            board: this.board,
          }, opts)
        );
